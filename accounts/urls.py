...
from accounts.views import AccountLoginView, AccountLogoutView, AccountSignupView, AccountProfileView, \
    AccountEditView, AccountChangePassword, AccountDeleteView, AccountDeletionConfirmedView
